...
export async function enrichMatch(home, away, kickoffIso) {
  try {
    ...
    for (const e of events) {
      ...
      const homeGoals = parseGoalDetails(straight ? e.strHomeGoalDetails : e.strAwayGoalDetails)
      const awayGoals = parseGoalDetails(straight ? e.strAwayGoalDetails : e.strHomeGoalDetails)
      return {
